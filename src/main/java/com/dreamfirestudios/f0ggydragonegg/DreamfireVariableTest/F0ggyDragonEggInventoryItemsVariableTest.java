package com.dreamfirestudios.f0ggydragonegg.DreamfireVariableTest;
...
public class F0ggyDragonEggInventoryItemsVariableTest implements DreamfireVariableTest {
    @Override
