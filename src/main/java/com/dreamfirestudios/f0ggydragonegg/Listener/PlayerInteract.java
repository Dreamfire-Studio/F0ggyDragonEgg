...
public class PlayerInteract implements Listener {
    ...
    public void onPlayerInteract(PlayerInteractEvent event){
        ...
        F0ggyDragonEggConfig.ReturnStaticAsync(F0ggyDragonEgg.GetF0ggyDragonEgg(), F0ggyDragonEggConfig.class, f0ggyDragonEggConfig -> {
            ...
            if(action == Action.RIGHT_CLICK_AIR || action == Action.RIGHT_CLICK_BLOCK){
                F0ggyDragonEggPermissions.ReturnStaticAsync(F0ggyDragonEgg.GetF0ggyDragonEgg(),F0ggyDragonEggPermissions.class, f0ggyDragonEggPermissions -> {
